        ...
        return (
            <div id="sidebar-menu" className="sideBarMenuContainer">
                <Navbar fluid className="sidebar">
                    ...
                    <Navbar.Collapse>
                        <Nav>
                            <NavItem href={`/${USER_LEVEL()}/penjualan`} eventKey={1}><img className="images" src={`/${'images/penjualan.svg'}`}/><span className="none">Penjualan</span></NavItem>
                            <NavItem href={`/${USER_LEVEL()}/pesan`} eventKey={2}><img className="images" src={`/${'images/pesan.svg'}`}/><span className="none">Pesan</span></NavItem>
                            <NavItem href={`/${USER_LEVEL()}/penjualan`} eventKey={3}><img className="images" src={`/${'images/nego.svg'}`}/><span className="none">Negosiasi</span></NavItem>
                            <NavItem href={`/${USER_LEVEL()}/mitra`} eventKey={4}><img className="images" src={`/${'images/mitra.svg'}`}/><span className="none">Mitra</span></NavItem>
